  ...
  return (
    <div className="space-y-3">
      <div className="space-y-2 text-xs text-muted-foreground">
        <p>
          Imprimé sur la facture, l&apos;avoir et le contrat de prêt dans un cadre fixe de{" "}
          <strong className="font-medium text-foreground">40 × 15 mm</strong>, dont 37 × 12 mm
          utiles. L&apos;image est réduite pour tenir dedans sans jamais être déformée.
        </p>
        <p>
          Taille conseillée :{" "}
          <strong className="font-medium text-foreground">440 × 140 pixels</strong> pour un logo
          allongé — soit 300 dpi sur la zone utile, la finesse attendue à l&apos;impression. Un
          logo carré n&apos;occupera que 12 × 12 mm, donc 140 × 140 pixels suffisent : un format
          allongé horizontalement exploite mieux le cadre.
        </p>
        <p>
      ...
      <div className="flex items-center gap-4">
        <div className="flex h-[57px] w-[151px] shrink-0 items-center justify-center rounded-md border bg-secondary/30">
          {hasLogo ? (
            // Proportions du cadre du PDF (40 × 15 mm) à l'échelle, pour montrer
            // l'encombrement réel plutôt qu'un aperçu trompeur.
