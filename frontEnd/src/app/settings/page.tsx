...
import SettingsForm, { type AppointmentCategory } from "./SettingsForm";
...
export default async function SettingsPage() {
  ...
  // Réglages et catégories rendus ensemble par le serveur : la page s'affiche
  // garnie du premier coup (cf. § 80).
